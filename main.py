...
def get_predictions(
    ...
    if charts[1] == True:
        XGBRegressor_result_of_testing_to_visualize, XGBRegressor_result_of_predictions, XGBRegressor_last_record_test_score,XGBRegressor_status, XGB_train_loss, XGB_test_loss, XGB_last_record_train_score= (
        ...
        fig_xgb = get_plot(
            ...
            days_in_future_to_predict,
            XGBRegressor_last_record_test_score,
